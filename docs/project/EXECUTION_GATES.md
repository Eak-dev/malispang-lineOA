...
After the `2026.09.06-v3` control transition is validated, pushed and reconciled with GitHub #9/#12, stop. Start the WP6 assessment only in a later Owner-instructed round. This transition records WP5 local acceptance as `PASS_WITH_LIMITATIONS`, leaves Issue #12 open, and does not authorize assessment execution, configuration changes, a PR, deployment or Production access/action.
